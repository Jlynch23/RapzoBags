...
function Config:CreateFrame()
    ...
    frame.title:SetText("Rapzo Bags - Modulos y configuracion")
    ...
    intro:SetText("Cada carpeta es un addon independiente. Aqui puedes apagar funciones cargadas; para no cargar un modulo en absoluto, desmarcalo en la pantalla de AddOns y haz /reload.")
...
function Config:Refresh()
    ...
    for _, line in ipairs(frame.statusLines or {}) do
        ...
        line.text:SetText(string.format("%s: %s   Funcion: %s", line.label, loaded and "|cff38e66bCARGADO|r" or "|cffef4444NO CARGADO|r", runtime and "|cff38e66bON|r" or "|cffef4444OFF|r"))
    end
...
RB:RegisterCommand("config", function() Config:Show() end, "/rbags config - abre el panel modular")
