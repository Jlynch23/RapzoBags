...
local RESOURCE_HEIGHT = 10
local RESOURCE_WIDTH = 224
local RESOURCE_Y = -4
local CAST_GAP = 4
local MAX_PIPS = 10
...
local function ensureResourceFrame(display)
    ...
    frame:SetPoint("TOPLEFT", display, "BOTTOMLEFT", 66, RESOURCE_Y)
...
function HUD:ApplyClassResourceCastAnchor(unit, castBar)
    ...
    if self:GetStyle() == 2 and resource and resource:IsShown() then
        ...
        castBar:SetPoint("TOPLEFT", display, "BOTTOMLEFT", 66, -4)
